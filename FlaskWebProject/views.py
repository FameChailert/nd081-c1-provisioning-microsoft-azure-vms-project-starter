...
def authorized():
    ...
    if "error" in request.args:  # Authentication/Authorization failure
        app.logger.warning("Invalid Login attempt detected, please try again")
    ...
    if request.args.get('code'):
        ...
        app.logger.warning("Microsoft account with the name of: "+session["user"]["name"]+" has logged in")
        login_user(user)
        _save_cache(cache)
    return redirect(url_for('home'))
